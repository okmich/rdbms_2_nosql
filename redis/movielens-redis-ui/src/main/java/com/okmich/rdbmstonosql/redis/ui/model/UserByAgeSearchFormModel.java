 ...
 */
public class UserByAgeSearchFormModel implements SearchFormModel<String> {
    ...
    public UserByAgeSearchFormModel(UserDao dao) {
        this.dao = dao;
    ...
    public void update(Object... args) {
        ...
        this.searchResult = dao.findUsersByAgeGroup(args[0].toString(),
        ...
        this.recordCount = dao.countUsersByAgeGroup(args[0].toString());
    }
    ...
    public String[] searchCriteria() {
        List<String> list = dao.getAllAgeGroups();
